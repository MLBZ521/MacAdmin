...
###################################################################################################
# Script Name:  build_Avast.sh
# By:  Zack Thompson / Created:  2/9/2018
# Version:  1.0 / Updated:  2/9/2018 / By:  ZT
#
# Description:  This script uses munkipkg to build an Avast package.
#
###################################################################################################

/bin/echo "*****  Build Avast process:  START  *****"
...
function getHelp {
/bin/echo "
usage:  build_Avast.sh [-install] [-update] [-version] <value> -help

Info:	Uses munkipkg to build a package for use in Jamf.

Actions:
	-install	Builds a package to install a new version
			Example:  build_Avast.sh -install -version latest

	-update		Builds a package to install a patch
			Example:  build_Avast.sh  -update -version latest

	-help	Displays this help text.
			Example:  build_Avast.sh -help
"
}
...
case $switch1 in
	-install )
		/bin/cp "${scriptDirectory}"/install_Avast.sh "${scriptDirectory}"/scripts/postinstall
...
/bin/echo "*****  Build Avast process:  COMPLETE  *****"
exit 0